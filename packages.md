...
```
printer-driver-all k3b nautilus net-tools wireshark tcpdump libpcap-dev exuberant-ctags gnome-terminal
```
...
```
vlc xserver-xorg-input-synaptics r-base neovim ncdu librecad vpnc
```
